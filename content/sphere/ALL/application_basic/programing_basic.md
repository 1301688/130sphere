...
description: "Programingの基本"
emoji: "🧑‍💻"
topImage: ""
---

#### 記事構成　冒頭まとめ項目
- ブラウザへ渡す言語=JavaScript,HTML,CSS
- サーバーデータをブラウザ言語側へ渡す言語=Node.js,C,C++,Physon,JAVA,GO,PHP
- データベースのデータをサーバーへ渡す言語=query言語,SQL,GraphQL,NoSQL
